...
export default function TokenPage({ nft, contractMetadata }: Props) {
  ...
  return (
    <>
      <Head>
        <title>{nft.metadata.name ? `${nft.metadata.name} #${nft.metadata.id}` : 'No Title'} | Owl Market</title>
      </Head>
...
export const getStaticProps: GetStaticProps = async (context) => {
  ...
  const sdk = new ThirdwebSDK(THIRDWEB_NETWORK_CONFIG);
